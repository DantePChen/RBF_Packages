...
public:
	...
	OPENMAYA_ENUM(MMayaFeatureSet,
		kComplete,		//!< Full set of all features available for given version of Maya is available
		kRestricted		//!< Some features are restricted and/or not available at all
	);
