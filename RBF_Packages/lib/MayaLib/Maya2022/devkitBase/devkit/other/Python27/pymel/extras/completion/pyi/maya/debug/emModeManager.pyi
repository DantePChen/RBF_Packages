...
class emModeManager(DebugTrace):
    ...
    @mode.setter
    def mode(self, value): ...
    idle_action_build : int
    
    idle_action_buildAndManipPrepare : int
    
    idle_action_manipPrepare : int
    
    idle_action_none : int
...
EVALUATOR_LIBRARIES : dict
RE_MODE : re.SRE_Pattern
RE_EVALUATORS : re.SRE_Pattern
EVALUATOR_PLUGINS : dict
