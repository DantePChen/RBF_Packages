...
class footPrint(omui.MPxLocatorNode):
	id = om.MTypeId( 0x0008006A )
	drawDbClassification = "drawdb/geometry/footPrint_GeometryOverride_AnimatedMaterial_py"
	drawRegistrantId = "footPrintNode_GeometryOverride_AnimatedMaterialPlugin_py"
...
def initializePlugin(obj):
	...
	try:
		plugin.registerNode("py2FootPrint_GeometryOverride_AnimatedMaterial", footPrint.id, footPrint.creator, footPrint.initialize, om.MPxNode.kLocatorNode, footPrint.drawDbClassification)
	except:
