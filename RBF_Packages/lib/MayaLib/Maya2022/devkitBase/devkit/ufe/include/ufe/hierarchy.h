...
public:
    ...
    */
    ...
    /*! Create a new group object as a child of this object and move all items 
        in the Selection under it.  Returned SceneItem will be the newly created
        parent.  The argument component is the desired name of the created
        group.  The resulting name will be different if an existing sibling
        already has that name.
        \param selection Items to be moved under the new group
    ...
    */
    ...
    /*! Create a command to create a new group object as a child of this object and move all items 
        in the Selection under it.  The argument component is the desired name of the created
        group.  The resulting name will be different if an existing sibling.
