...
public:
    ...
    // RJ
		...
		kDoubleToAngleNode,					//!< \nop
		kAbsolute,
		kACos,								//!< arc cosines math node
		kAnd,
		kASin,								//!< arc sine math node
		kATan,								//!< arc tangent math node
		kATan2,								//!< arc tangent 2 math node
		kAverage,
		kCeil,
		kClampRange,
		kCos,								//!< cosines math node
		kDeterminant,
		kEqual,
		kFloor,
		kGreaterThan,
