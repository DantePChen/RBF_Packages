...
class DragAndDropBehavior(_MPxDragAndDropBehavior):
    ...
    kAttributeCandidates : list
    
    kErrorMsg_IncompatibleTypes : unicode
    
    kErrorMsg_NoAttributeFound : unicode
    
    kErrorMsg_NoShadingGroup : unicode
    
    kErrorMsg_NoShadingGroupFound : unicode
    
    kErrorMsg_NoSurfaceShader : unicode
    
    kErrorMsg_NoSurfaceShaderFound : unicode
