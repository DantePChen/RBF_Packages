...
Notes:
  * Uses mayaMixin to handle details of using PySide2 in Maya
...
# Import Qt
try:
    from PySide2.QtWidgets import QScrollArea, QWidget, QFormLayout, QLineEdit
except:
    from PySide6.QtWidgets import QScrollArea, QWidget, QFormLayout, QLineEdit
...
class Example_connectAttr(MayaQWidgetDockableMixin, QScrollArea):
    ...
    def _processDeferredUpdateRequest(self):
        ...
        '''
        for widget, nodeAttrName in list(self._deferredUpdateRequest.items()):
