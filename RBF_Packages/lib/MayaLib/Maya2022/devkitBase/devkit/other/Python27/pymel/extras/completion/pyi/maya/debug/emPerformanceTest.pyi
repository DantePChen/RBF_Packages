...
class emPerformanceOptions(object):
    ...
    def usesEvaluationManager(self):
        ...
        """
        ...
    COLUMN_STAT_AVG : unicode
    
    COLUMN_STAT_MAX : unicode
    
    COLUMN_STAT_MIN : unicode
    
    COLUMN_STAT_TIME : unicode
    
    COLUMN_TITLE_END_FRAME : unicode
    
    COLUMN_TITLE_START_FRAME : unicode
    
    EVALUATION_MODE_DG : str
    
    EVALUATION_MODE_EM_PARALLEL : str
    
    EVALUATION_MODE_EM_SERIAL : str
    
    TEST_DIRTY : str
    
    TEST_DIRTY_REFRESH : str
    
    TEST_GRAPH_CREATION : str
    
    TEST_GRAPH_SCHEDULING : str
...
class emPerformanceResults(object):
    ...
    def startRep(self, rep):
        ...
        """
        ...
    RepData : Type[maya.debug.emPerformanceTest.RepData]
...
EMPERFORMANCE_PLAYBACK_MAX : int
