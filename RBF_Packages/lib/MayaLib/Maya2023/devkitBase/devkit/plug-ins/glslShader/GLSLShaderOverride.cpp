...
MString GLSLShaderOverride::initialize(const MInitContext& initContext, MSharedPtr<MUserData>&)
{
	fShaderNode = NULL;
...
MHWRender::MShaderInstance* GLSLShaderOverride::shaderInstance(MDrawContext&) const
{
