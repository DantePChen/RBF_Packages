...
class OPENMAYAUI_EXPORT OPENMAYA_DEPRECATED(< 2024, "Use MHWRender::MRenderItem and MHWRender::MPxGeometryOverride instead for Viewport 2.0 support.") MSelectInfo : public MDrawInfo
{
public:
	MSelectInfo();
