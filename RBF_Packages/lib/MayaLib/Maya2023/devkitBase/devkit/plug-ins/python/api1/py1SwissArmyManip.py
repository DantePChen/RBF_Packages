...
# DESCRIPTION:
#
# Produces the dependency graph nodes "spSwissArmyLocator" and "spSwissArmyLocatorManip". 
# 
...
kSwissArmyLocatorId = OpenMaya.MTypeId(0x0008004d)
kSwissArmyLocatorManipName = "spSwissArmyLocatorManip"
kSwissArmyLocatorManipId = OpenMaya.MTypeId(0x0008004e)
