...
namespace MHWRender
{
	class THgeometryOverrideEvaluator;
}
...
Note that without overriding this method or making the method return false
...
protected:
	...
	virtual void invokeTheCallback(MDrawContext& drawContext, MUserData* userData);

OPENMAYA_PRIVATE:
	GeometryDrawOverrideCb fCallback;
	bool fIsAlwaysDirty;
	 
	friend class ::MHWRender::THgeometryOverrideEvaluator;
};
