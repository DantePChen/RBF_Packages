...
public:
	...
	void glShaderSourceARB(MGLhandleARB shaderObj, MGLsizei count, const MGLcharARB * const *string, const MGLint *length);
	...
	void glTransformFeedbackVaryingsEXT(MGLuint program, MGLsizei count, const MGLcharARB * const * varyings, MGLenum bufferMode);
