...
public:
    ...
    MString getCurrentUfeCameraPath(MStatus* ReturnStatus=nullptr) const;
    ...
    OPENMAYA_ENUM(TransparencyAlgorithm,
		kUnsorted,			//!< Unsorted transparent object drawing
    ...
    OPENMAYA_ENUM(WireOnShadedMode,
    ...
    OPENMAYA_ENUM(RenderingDestination,
	...
	*/
	//@{
	static constexpr MUint64 kExcludeNone				= MUint64(0);			//!< Exclude no object types
	static constexpr MUint64 kExcludeNurbsCurves		= MUint64(1) << (0);	//!< Exclude NURBS curves
	static constexpr MUint64 kExcludeNurbsSurfaces		= MUint64(1) << (1);	//!< Exclude NURBS surface
	static constexpr MUint64 kExcludeMeshes				= MUint64(1) << (2);	//!< Exclude polygonal meshes
	static constexpr MUint64 kExcludePlanes				= MUint64(1) << (3);	//!< Exclude planes
	static constexpr MUint64 kExcludeLights				= MUint64(1) << (4);	//!< Exclude lights
	static constexpr MUint64 kExcludeCameras			= MUint64(1) << (5);	//!< Exclude camera
	static constexpr MUint64 kExcludeJoints				= MUint64(1) << (6);	//!< Exclude joints
	static constexpr MUint64 kExcludeIkHandles			= MUint64(1) << (7);	//!< Exclude IK handles
	static constexpr MUint64 kExcludeDeformers			= MUint64(1) << (8);	//!< Exclude all deformations
	static constexpr MUint64 kExcludeDynamics			= MUint64(1) << (9);	//!< Exclude all dynamics objects (emiiters, cloth)
	static constexpr MUint64 kExcludeParticleInstancers	= MUint64(1) << (10);	//!< Exclude all Particle Instancers
	static constexpr MUint64 kExcludeLocators			= MUint64(1) << (11);	//!< Exclude locators
	static constexpr MUint64 kExcludeDimensions			= MUint64(1) << (12);	//!< Exclude all measurement objects
	static constexpr MUint64 kExcludeSelectHandles		= MUint64(1) << (13);	//!< Exclude selection handles
	static constexpr MUint64 kExcludePivots				= MUint64(1) << (14);	//!< Exclude pivots
	static constexpr MUint64 kExcludeTextures			= MUint64(1) << (15);	//!< Exclude texure placement objects
	static constexpr MUint64 kExcludeGrid				= MUint64(1) << (16);	//!< Exclude grid drawing
	static constexpr MUint64 kExcludeCVs				= MUint64(1) << (17);	//!< Exclude NURBS control vertices
	static constexpr MUint64 kExcludeHulls				= MUint64(1) << (18);	//!< Exclude NURBS hulls
	static constexpr MUint64 kExcludeStrokes			= MUint64(1) << (19);	//!< Exclude PaintFX strokes
	static constexpr MUint64 kExcludeSubdivSurfaces		= MUint64(1) << (20);	//!< Exclude subdivision surfaces
	static constexpr MUint64 kExcludeFluids				= MUint64(1) << (21);	//!< Exclude fluid objects
	static constexpr MUint64 kExcludeFollicles			= MUint64(1) << (22);	//!< Exclude hair follicles
	static constexpr MUint64 kExcludeHairSystems		= MUint64(1) << (23);	//!< Exclude hair system
	static constexpr MUint64 kExcludeImagePlane			= MUint64(1) << (24);	//!< Exclude image planes
	static constexpr MUint64 kExcludeNCloths			= MUint64(1) << (25);	//!< Exclude N-cloth objects
	static constexpr MUint64 kExcludeNRigids			= MUint64(1) << (26);	//!< Exclude rigid-body objects
	static constexpr MUint64 kExcludeDynamicConstraints	= MUint64(1) << (27);	//!< Exclude rigid-body constraints
	static constexpr MUint64 kExcludeManipulators		= MUint64(1) << (28);	//!< Exclude manipulators
	static constexpr MUint64 kExcludeNParticles			= MUint64(1) << (29);	//!< Exclude N-particle objects
	static constexpr MUint64 kExcludeMotionTrails		= MUint64(1) << (30);	//!< Exclude motion trails
	static constexpr MUint64 kExcludeHoldOuts			= MUint64(1) << (31);	//!< Exclude Hold-Outs
	static constexpr MUint64 kExcludePluginShapes		= MUint64(1) << (32);	//!< Exclude plug-in shapes
	static constexpr MUint64 kExcludeHUD				= MUint64(1) << (33);	//!< Exclude HUD
	static constexpr MUint64 kExcludeClipGhosts			= MUint64(1) << (34);	//!< Exclude animation clip ghosts
	static constexpr MUint64 kExcludeGreasePencils		= MUint64(1) << (35);	//!< Exclude grease-pencil draw
	static constexpr MUint64 kExcludeControllers		= MUint64(1) << (36);	//!< Exclude Controllers
	static constexpr MUint64 kExcludeAll				= ~MUint64(0);			//!< Exclude all listed object types
	//@}
    ...
    OPENMAYA_AVAILABLE(2024)
    void viewTransformName(MString& viewTransformName) const;
    enum Direction
    {
    ...
    OPENMAYA_AVAILABLE(2024)
    MColor applyViewTransform(const MColor& color, Direction direction) const;
...
private:
	mutable MSelectionInfo fSelectionInfo;
};
