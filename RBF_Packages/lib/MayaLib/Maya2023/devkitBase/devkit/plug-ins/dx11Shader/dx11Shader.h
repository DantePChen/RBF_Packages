...
#include <d3dx11.h>
	...
	// d3dx11effect.h comes from the D3DX11Effects library installer
	// or the DirectX SDK installer (legacy)
	// DirectX is now part of the Windows SDK installer
	#include <d3dx11effect.h>

	// have legacy DirectX SDK (June 2010)
