...
#define kRockingTransformNodeID 0x81109
#define kRockingTransformMatrixID 0x8110A
...
class rockingTransformMatrix : public MPxTransformationMatrixPreRotation
{
	...
	public:
		...
		static	MTypeId	id;
	protected:		
		typedef MPxTransformationMatrixPreRotation ParentClass;
		// Degrees
		double rockXValue;
};

class rockingTransformNode : public MPxTransformPreRotation
{
	...
	public:
        ...
        MStatus     computeLocalTransformation(MPxTransformationMatrix *xform, MDataBlock &block) override;

		static	MTypeId	id;
	protected:
		// Degrees
		static	MObject aRockInX;
		typedef MPxTransformPreRotation ParentClass;
};
