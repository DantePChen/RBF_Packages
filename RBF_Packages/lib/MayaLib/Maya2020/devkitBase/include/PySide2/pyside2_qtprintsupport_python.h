...
enum : int {
    ...
    SBK_QTPRINTSUPPORT_QLIST_QPRINTER_DUPLEXMODE_IDX         = 5, // QList<QPrinter::DuplexMode >
    SBK_QTPRINTSUPPORT_QLIST_QPAGESIZE_IDX                   = 6, // QList<QPageSize >
    SBK_QTPRINTSUPPORT_QLIST_QPAGEDPAINTDEVICE_PAGESIZE_IDX  = 7, // QList<QPagedPaintDevice::PageSize >
    SBK_QTPRINTSUPPORT_QPAIR_QSTRING_QSIZEF_IDX              = 8, // QPair<QString,QSizeF >
    SBK_QTPRINTSUPPORT_QLIST_QPAIR_QSTRING_QSIZEF_IDX        = 9, // QList<QPair< QString,QSizeF > >
    SBK_QTPRINTSUPPORT_QLIST_QVARIANT_IDX                    = 10, // QList<QVariant >
    SBK_QTPRINTSUPPORT_QLIST_QSTRING_IDX                     = 11, // QList<QString >
    SBK_QTPRINTSUPPORT_QMAP_QSTRING_QVARIANT_IDX             = 12, // QMap<QString,QVariant >
    SBK_QtPrintSupport_CONVERTERS_IDX_COUNT                  = 13
};
