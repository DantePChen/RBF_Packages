...
/*!
  ...
  so is responsible notifications which affect its objects. The Ufe scene is 
  organized into \ref Ufe::SceneSegmentHandler "scene segments" which form a tree.
...
public:
    ...
    //! Notify observers.
    //! \param notification The notification, must be derived from SceneChanged.
