...
enum : int {
    ...
    SBK_QTCORE_QLIST_QFILEINFO_IDX                           = 27, // QList<QFileInfo >
    SBK_QTCORE_QVECTOR_QPOINTF_IDX                           = 28, // QVector<QPointF >
    SBK_QTCORE_QLIST_QITEMSELECTIONRANGE_IDX                 = 29, // const QList<QItemSelectionRange > &
    SBK_QTCORE_QSET_QITEMSELECTIONRANGE_IDX                  = 30, // const QSet<QItemSelectionRange > &
    SBK_QTCORE_QVECTOR_QITEMSELECTIONRANGE_IDX               = 31, // const QVector<QItemSelectionRange > &
    SBK_QTCORE_QLIST_QLOCALE_COUNTRY_IDX                     = 32, // QList<QLocale::Country >
    SBK_QTCORE_QLIST_QLOCALE_IDX                             = 33, // QList<QLocale >
    SBK_QTCORE_QLIST_QT_DAYOFWEEK_IDX                        = 34, // QList<Qt::DayOfWeek >
    SBK_QTCORE_QLIST_QURL_IDX                                = 35, // const QList<QUrl > &
    SBK_QTCORE_QLIST_QMIMETYPE_IDX                           = 36, // QList<QMimeType >
    SBK_QTCORE_QPAIR_QREAL_QVARIANT_IDX                      = 37, // QPair<qreal,QVariant >
    SBK_QTCORE_QVECTOR_QPAIR_QREAL_QVARIANT_IDX              = 38, // QVector<QPair< qreal,QVariant > >
    SBK_QTCORE_QLIST_QABSTRACTTRANSITIONPTR_IDX              = 39, // QList<QAbstractTransition* >
    SBK_QTCORE_QSET_QABSTRACTSTATEPTR_IDX                    = 40, // QSet<QAbstractState* >
    SBK_QTCORE_QLIST_QSTORAGEINFO_IDX                        = 41, // QList<QStorageInfo >
    SBK_QTCORE_QLIST_INT_IDX                                 = 42, // QList<int >
    SBK_QTCORE_QVECTOR_QTIMEZONE_OFFSETDATA_IDX              = 43, // QVector<QTimeZone::OffsetData >
    SBK_QTCORE_QPAIR_QSTRING_QSTRING_IDX                     = 44, // QPair<QString,QString >
    SBK_QTCORE_QLIST_QPAIR_QSTRING_QSTRING_IDX               = 45, // QList<QPair< QString,QString > >
    SBK_QTCORE_QVECTOR_QXMLSTREAMATTRIBUTE_IDX               = 46, // QVector<QXmlStreamAttribute > &
    SBK_QTCORE_QLIST_QXMLSTREAMATTRIBUTE_IDX                 = 47, // const QList<QXmlStreamAttribute > &
    SBK_QTCORE_QVECTOR_QXMLSTREAMNAMESPACEDECLARATION_IDX    = 48, // const QVector<QXmlStreamNamespaceDeclaration > &
    SBK_QTCORE_QVECTOR_QXMLSTREAMENTITYDECLARATION_IDX       = 49, // QVector<QXmlStreamEntityDeclaration >
    SBK_QTCORE_QVECTOR_QXMLSTREAMNOTATIONDECLARATION_IDX     = 50, // QVector<QXmlStreamNotationDeclaration >
    SBK_QTCORE_QLIST_QSTRING_IDX                             = 51, // QList<QString >
