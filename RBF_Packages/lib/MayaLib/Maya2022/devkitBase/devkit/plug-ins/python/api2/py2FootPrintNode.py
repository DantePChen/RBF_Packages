...
class footPrint(omui.MPxLocatorNode):
	id = om.MTypeId( 0x00080067 )
	drawDbClassification = "drawdb/geometry/footPrint_py"
	drawRegistrantId = "FootprintNodePlugin_py"
...
def initializePlugin(obj):
	...
	try:
		plugin.registerNode("footPrint_py", footPrint.id, footPrint.creator, footPrint.initialize, om.MPxNode.kLocatorNode, footPrint.drawDbClassification)
	except:
