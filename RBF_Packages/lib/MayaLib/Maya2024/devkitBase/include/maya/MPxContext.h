...
BEGIN_NO_SCRIPT_SUPPORT:
	...
	//! \noscript
	OPENMAYA_DEPRECATED(2024, "Instead, a callback must be set using MTimerMessage::addTimerCallback and this callback can then invoke M3dView::refresh to trigger a refresh")
...
public: 
	// Added at the end to avoid breaking compat.
	OPENMAYA_AVAILABLE(2024)
