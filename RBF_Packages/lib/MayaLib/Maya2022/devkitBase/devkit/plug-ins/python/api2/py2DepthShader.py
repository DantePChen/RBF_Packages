...
## Plugin setup
#######################################################
sRegistrantId = "depthShaderPlugin_py"

def initializePlugin(obj):
	plugin = om.MFnPlugin(obj, "Autodesk", "4.5", "Any")
	try:
		userClassify = "shader/surface:drawdb/shader/surface/depthShader_py"
		plugin.registerNode("depthShader_py", depthShader.id, depthShader.creator, depthShader.initialize, om.MPxNode.kDependNode, userClassify)
	except:
	...
	try:
		...
		omr.MDrawRegistry.registerSurfaceShadingNodeOverrideCreator("drawdb/shader/surface/depthShader_py", sRegistrantId, depthShaderOverride.creator)
	except:
...
def uninitializePlugin(obj):
	...
	try:
		global sRegistrantId
		omr.MDrawRegistry.deregisterSurfaceShadingNodeOverrideCreator("drawdb/shader/surface/depthShader_py", sRegistrantId)
	except:
