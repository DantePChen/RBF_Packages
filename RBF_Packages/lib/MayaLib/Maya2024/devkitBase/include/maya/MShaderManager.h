...
public:
	...
	MStatus addInputFragmentForMultiParams(
		const MString& fragmentName,
	...
	OPENMAYA_AVAILABLE(2024.2)
	MStatus addColorManagementTextures();
...
public:
    ...
    OPENMAYA_ENUM(MStockShader,
		...
		k3dPointLightShadowerShader, //!< An instance of a stock shader which can be used when rendering point light shadow maps
		OPENMAYA_AVAILABLE(2020)
        k3dStandardSurfaceShader, //!< An instance of a standard surface shader for 3d rendering
		OPENMAYA_AVAILABLE(2023)
		k3dIsotropicStandardSurfaceShader, //!< An instance of a standard surface shader for 3d rendering, without anisotropy support and tangent geometry requirement.
