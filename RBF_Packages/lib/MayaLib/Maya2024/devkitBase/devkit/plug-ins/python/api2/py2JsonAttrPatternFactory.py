"""
To use, make sure that py2JsonAttrPatternFactory.py is in your MAYA_PLUG_IN_PATH
then do the following:

import maya
maya.cmds.loadPlugin("py2JsonAttrPatternFactory.py")
...
def import_helpers():
	...
	module = __import__('pyJsonAttrPatternInfo', globals(), locals(), ["PyJsonAttrPatternInfo", "jsonDebug"])
...
class PyJsonAttrPatternFactory(omAPI.MPxAttributePatternFactory):
	...
	def name(self):
		...
		"""
		return JsonKeys.kPluginPatternFactoryName.encode('utf-8')
