...
*/
class OPENMAYAUI_EXPORT OPENMAYA_DEPRECATED(<2024, "Use MHWRender::MPxGeometryOverride, MHWRender::MPxSubSceneOverride, or MHWRender::MPxDrawOverride instead for Viewport 2.0 support.") MPxSurfaceShapeUI
{
public:
	MPxSurfaceShapeUI();
