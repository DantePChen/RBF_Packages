...
class ReferenceEdit(str):
    ...
    @fullNamespace.setter
    def fullNamespace(self, value): ...
    @property
    def namespace(self): ...
    @namespace.setter
    def namespace(self, value): ...
    @property
    def rawEditData(self): ...
    @rawEditData.setter
    def rawEditData(self, value): ...
    __dict__ : dictproxy
...
class Workspace(object):
    ...
    fileRules : WorkspaceEntryDict
    
    objectTypes : WorkspaceEntryDict
    
    renderTypes : WorkspaceEntryDict
    
    variables : WorkspaceEntryDict
