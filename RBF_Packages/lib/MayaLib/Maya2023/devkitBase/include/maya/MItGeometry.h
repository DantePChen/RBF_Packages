...
private:
	...
	void 		createIterator(MDataHandle& dataHandle,
							   ...
							   void* comps,
							   unsigned int groupId,
							   const char* componentTagExpression,
							   bool readOnly,
							   MStatus* status);
...
OPENMAYA_PRIVATE:
   ...
   void initializeEmpty(MDataHandle& dataHandle,
                        bool readOnly,
                        MStatus * ReturnStatus = NULL);

   void initializeComplete(MDataHandle& dataHandle,
                           bool readOnly = true,
                           MStatus * ReturnStatus = NULL);

   void initializePartial(MDataHandle& dataHandle,
                          void* comps,
                          bool readOnly = true,
                          MStatus * ReturnStatus = NULL);
