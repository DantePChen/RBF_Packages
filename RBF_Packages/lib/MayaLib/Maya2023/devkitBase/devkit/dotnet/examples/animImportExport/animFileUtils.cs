...
namespace MayaNetPlugin
{
	...
	public class animBase
	{
		...
		public const string kWordTangentAutoEase = "autoease";
		public const string kWordTangentAutoMix = "automix";
		public const string kWordTangentAutoCustom = "autocustom";
		...
		//
		{
			switch (type)
			{
				...
				case MFnAnimCurve.TangentType.kTangentAutoEase:
					return (kWordTangentAutoEase);
				case MFnAnimCurve.TangentType.kTangentAutoMix:
					return (kWordTangentAutoMix);
				case MFnAnimCurve.TangentType.kTangentAutoCustom:
		...
		//
		{
			...
			if (string.Compare(type, kWordTangentAutoEase) == 0)
			{
				return (MFnAnimCurve.TangentType.kTangentAutoEase);
			}
			if (string.Compare(type, kWordTangentAutoMix) == 0)
			{
				return (MFnAnimCurve.TangentType.kTangentAutoMix);
			}
			if (string.Compare(type, kWordTangentAutoCustom) == 0)
			{
				return (MFnAnimCurve.TangentType.kTangentAutoCustom);
			}
