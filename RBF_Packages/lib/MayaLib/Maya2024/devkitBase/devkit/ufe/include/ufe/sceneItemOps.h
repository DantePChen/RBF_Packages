...
public:
    ...
    */
    ...
    //! \return Pointer to an undoable command whose undo removes the duplicated object(s).
    ...
    //! \return Pointer to an undoable command object whose undo method will revert the rename.
