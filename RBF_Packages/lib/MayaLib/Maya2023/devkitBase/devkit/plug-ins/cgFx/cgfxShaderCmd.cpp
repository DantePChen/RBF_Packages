...
//
{
	...
	if ( fIsQuery ) {
        ...
        // -euv / -emptyUV
        //     Returns the names of UV sets on a blocked list.  These UV sets
        ...
        //     UV set is accessed by a hardware shader.  The blocked list is
        ...
        //     which are causing the UV set names to be added to a blocked list.
