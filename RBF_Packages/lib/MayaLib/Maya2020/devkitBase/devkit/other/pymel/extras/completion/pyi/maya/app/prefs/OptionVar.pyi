...
class OptionVar(object):
    ...
    def monitor_preference(self, value): ...
    StateError : Type[maya.app.prefs.OptionVar.StateError]
...
ERR_OV_NOT_INT : unicode
OPTION_VAR_TYPE_STRING : int
ERR_OV_NOT_STRING : unicode
DBG : DebugTrace
ERR_OV_NOT_ENUM : unicode
OPTION_VAR_TYPE_FLOAT : int
OPTION_VAR_TYPES : list
CREATE_DEBUG_PROXY : bool
ERR_OV_NOT_BOOL : unicode
ERR_OV_NOT_LEGAL_ENUM : unicode
OPTION_VAR_TYPE_BOOL : int
ERR_OV_TYPE_UNKNOWN : unicode
ERR_OV_NOT_FLOAT : unicode
