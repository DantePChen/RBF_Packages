...
/*!
  ...
  locator is a DAG shape that is drawn on the screen, but that is
...
public:
	MPxLocatorNode();
	~MPxLocatorNode() override;
	MPxNode::Type type() const override;

	// Methods to overload
	OPENMAYA_DEPRECATED(2024, "Please use MHWRender::MPxGeometryOverride, MHWRender::MPxSubSceneOverride, or MHWRender::MPxDrawOverride instead.")
