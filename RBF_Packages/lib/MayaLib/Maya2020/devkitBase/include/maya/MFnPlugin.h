...
public:
    ...
    static MStatus  registerPluginLoader  (const MString& pluginExtension, MPluginLoaderFunction loaderFnPtr, MPluginUnLoaderFunction unloaderFnPtr);
	static MStatus  unregisterPluginLoader(const MString& pluginExtension);
    void            setPluginEntryPoints  (MPluginEntryPoint init, MPluginEntryPoint unInit);
