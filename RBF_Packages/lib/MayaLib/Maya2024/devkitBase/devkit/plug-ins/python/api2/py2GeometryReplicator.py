...
def initializePlugin(obj):
	...
	try:
		plugin.registerShape("geometryReplicator_py", geometryReplicator.id, geometryReplicator.creator, geometryReplicator.initialize, geometryReplicator.drawDbClassification)
	except:
