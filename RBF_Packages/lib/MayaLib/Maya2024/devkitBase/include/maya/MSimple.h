...
/*!
  This macro expands to all the code necessary to create a plug-in for a NON-undoable
  command, with the exception of the doIt() method. The doIt() method needs to be
  ...
  This macro cannot be used to create undoable commands or commands that uses 
  flags or options.

  This macro takes as arguments the name of the class that will be
  ...
  derived from MPxCommand, as well as the following methods:
