...
# The output attribute of the BrickTexture node is called "outColor". To use this shader, create a BrickTexture 
# and connect its output to an input of a surface/shader node such as Color.
...
class brickTextureNode(om.MPxNode):
	...
	def compute(self, plug, block):
		...
		# The plug has been successfully computed
		return self
...
## Plugin setup
#######################################################
sRegistrantId = "brickTexturePlugin_py"

def initializePlugin(obj):
	plugin = om.MFnPlugin(obj, "Autodesk", "4.5", "Any")
	try:
		userClassify = "texture/2d:drawdb/shader/texture/2d/brickTexture_py"
		plugin.registerNode("brickTexture_py", brickTextureNode.id, brickTextureNode.creator, brickTextureNode.initialize, om.MPxNode.kDependNode, userClassify)
	except:
	...
	try:
		...
		omr.MDrawRegistry.registerShadingNodeOverrideCreator("drawdb/shader/texture/2d/brickTexture_py", sRegistrantId, brickTextureNodeOverride.creator)
	except:
...
def uninitializePlugin(obj):
	...
	try:
		global sRegistrantId
		omr.MDrawRegistry.deregisterShadingNodeOverrideCreator("drawdb/shader/texture/2d/brickTexture_py", sRegistrantId)
	except:
