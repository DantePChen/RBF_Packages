...
class footPrint(omui.MPxLocatorNode):
	id = om.MTypeId( 0x0008004b )
	drawDbClassification = "drawdb/geometry/footPrint_RenderUtilities_py"
	drawRegistrantId = "FootprintNode_RenderUtilities_py"
...
class footPrintDrawAgent(object):
	def __init__(self):
		self.mShader = None
...
"""
		return convertString(shaderCode)
...
def initializePlugin(obj):
	...
	try:
		plugin.registerNode("py2FootPrint", footPrint.id, footPrint.creator, footPrint.initialize, om.MPxNode.kLocatorNode, footPrint.drawDbClassification)
	except:
