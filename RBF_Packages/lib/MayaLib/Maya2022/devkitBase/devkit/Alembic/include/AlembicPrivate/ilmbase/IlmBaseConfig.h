...
// client namespaces.
#define ILMBASE_INTERNAL_NAMESPACE_CUSTOM ON
#define HALF_INTERNAL_NAMESPACE Half_2_4_maya
#define IMATH_INTERNAL_NAMESPACE Imath_2_4_maya
#define IEX_INTERNAL_NAMESPACE Iex_2_4_maya
#define ILMTHREAD_INTERNAL_NAMESPACE IlmThread_2_4_maya

#define ILMBASE_NAMESPACE_CUSTOM ON
