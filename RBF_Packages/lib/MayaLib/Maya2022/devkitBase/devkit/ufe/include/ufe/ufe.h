...
#define UFE_MAJOR_VERSION 2
#define UFE_MINOR_VERSION 1
#define UFE_PATCH_LEVEL   1
...
#define UFE_VERSIONED_NS UFE_CONCAT(UFE_NS, _v2)
...
/* #undef UFE_V3_FEATURES_AVAILABLE */
