...
protected:
	...
	bool isValidName(const MString &name, MString &validName) const;
	bool namesAreValid(const MString &fullName,  MString &validFullName,
	                   const MString &briefName, MString &validBriefName);
